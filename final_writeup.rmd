...
predictive_model = function(test_St, test_Re, test_Fr) {
  ...
  m1 = predict(model_m1, newdata =  newdata, se.fit = TRUE)
  m2 = predict(model_m2, newdata =  newdata, se.fit = TRUE)
  m3 = predict(model_m3, newdata =  newdata, se.fit = TRUE)
  m4 = predict(model_m4, newdata =  newdata, se.fit = TRUE)
